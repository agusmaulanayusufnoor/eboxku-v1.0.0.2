...
//   },
    ...
    initialize() {
      ...
      if(this.$gate.isAdmin() || this.$gate.isPelayanan() || this.$gate.isCs() || this.$gate.isTeller()){
        ...
        axios.get("api/deposito", { params }).then((response) => {
          this.deposito = response.data.data;
     ...
     createUser(){
         ...
         this.$Progress.start();
           ...
           // console.log(this.file);
            axios.post('api/deposito',formData,config)
              .then((response)=>{
                  $('#addNew').modal('hide');
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ya, Hapus!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/deposito/'+id).then(()=>{
                                        Swal.fire(
                                        'Dihapus!',
                                        'Data telah dihapus.',
                                        'success'

        ...
        <v-col cols="11">
          ...
          >
            <v-toolbar
              ...
              shaped
            >
              <v-toolbar-title> File Teller </v-toolbar-title>
              <v-spacer></v-spacer>
...
export default {
  ...
  methods: {
        ...
        if (this.$gate.isAdmin()) {
          axios
            ...
            .then((response) => {
              ...
              this.kantor_id = this.$nama_kantor;
              // this.form.fill
    ...
    createUser() {
      ...
      axios
        .post("api/teller", formData, config)
        .then((response) => {
          $("#addNew").modal("hide");

      ...
      initialize() {
         this.$Progress.start();
            ...
            if(this.$gate.isAdmin() || this.$gate.isUM() ){
             ...
             axios.get("api/pjkpph4ayat2")
                .then((response) => {
                this.pjkpph4ayat2 = response.data.data;
     ...
     createUser(){
         ...
         this.$Progress.start();
           ...
           // console.log(this.file);
            axios.post('api/pjkpph4ayat2',formData,config)
              .then((response)=>{
                  $('#addNew').modal('hide');
          ...
          updateUser(){
                ...
                this.form.put('api/pjkpph4ayat2/'+this.form.id)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ya, Hapus!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/pjkpph4ayat2/'+id).then(()=>{
                                        Swal.fire(
                                        'Dihapus!',
                                        'Data telah dihapus.',
                                        'success'

                            ...
                            >
                                ...
                                <template v-slot:activator="{ on, attrs }">
                                    <v-text-field
                                        ...
                                        @blur="tgl_pajak_tahunan = parseDate(dateFormatted2)"
     ...
     createUser(){
         ...
         this.$Progress.start();
          ...
          updateUser(){
                ...
                this.form.put('api/pjkkendaraan/'+this.form.id)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({

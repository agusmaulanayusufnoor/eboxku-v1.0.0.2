    ...
    async cekNorek (){
      if(this.$gate.isAdmin() || this.$gate.isKredit() || this.$gate.isBisnis() || this.$gate.isPelayanan() || this.$gate.isCs()){
        ...
        //const response = await axios.get('api/kredit/ceknama')
          const response = await axios.post('api/kredit/ceknorek',formData)
     ...
     createUser(){
         ...
         this.$Progress.start();
           ...
           // console.log(this.file);
            axios.post('api/kredit',formData,config)
              .then((response)=>{
                  $('#addNew').modal('hide');
          ...
          updateUser(){
                ...
                this.form.put('api/kredit/'+this.form.id)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ya, Hapus!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/kredit/'+id).then(()=>{
                                        Swal.fire(
                                        'Dihapus!',
                                        'Data telah dihapus.',
                                        'success'

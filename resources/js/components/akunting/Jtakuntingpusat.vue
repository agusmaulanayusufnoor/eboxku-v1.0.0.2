    ...
    methods: {
        async cekTgl (){
            if(this.$gate.isAdmin() || this.$gate.isAK() ){
                ...
                const response = await axios.post('api/jtakuntingpusat/cektgl',formData)
      ...
      initialize() {
         this.$Progress.start();
            ...
            if(this.$gate.isAdmin() || this.$gate.isAK() ){
             ...
             axios.get("api/jtakuntingpusat")
                .then((response) => {
                this.jtakuntingpusat = response.data.data;
     ...
     createUser(){
         ...
         this.$Progress.start();
           ...
           // console.log(this.file);
            axios.post('api/jtakuntingpusat',formData,config)
              .then((response)=>{
                  $('#addNew').modal('hide');
          ...
          updateUser(){
                ...
                this.form.put('api/jtakuntingpusat/'+this.form.id)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ya, Hapus!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/jtakuntingpusat/'+id).then(()=>{
                                        Swal.fire(
                                        'Dihapus!',
                                        'Data telah dihapus.',
                                        'success'

    ...
    formatDate (date) {
      ...
      getBarang() {
            ...
            if(this.$gate.isAdmin() || this.$gate.isAK() ){
             ...
             axios.get("api/stockpromosi/getbarang")
                .then((response) => {
      ...
      getKantor() {
            ...
            if(this.$gate.isAdmin() || this.$gate.isAK()){
               ...
               //axios.get("api/user").then((response) => {(this.users = response.data.data)});
             axios.get("api/stockpromosi/getkantor")
                .then((response) => {
      ...
      getSatuan() {
            ...
            if(this.$gate.isAdmin() || this.$gate.isAK() ){
               ...
               //axios.get("api/user").then((response) => {(this.users = response.data.data)});
             axios.get("api/stockpromosi/getsatuan")
                .then((response) => {
     ...
     createUser(){
        ...
        if(this.$gate.isAdmin() || this.$gate.isAK() ){
           ...
           // console.log(this.file);
            axios.post('api/stockpromosi',formData,config)
              .then((response)=>{
                  $('#addNew').modal('hide');
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ya, Hapus!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/stockpromosi/'+id).then(()=>{
                                        Swal.fire(
                                        'Dihapus!',
                                        'Data telah dihapus.',
                                        'success'

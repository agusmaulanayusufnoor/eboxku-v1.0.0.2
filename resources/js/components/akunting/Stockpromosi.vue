        ...
        <v-col cols="12">
          <v-card class="pa-2 mx-auto" v-if="$gate.isAdmin() || $gate.isAK()">
            <v-toolbar
              ...
              shaped
            >
              <v-toolbar-title> Stok Barang Promosi </v-toolbar-title>
              <v-spacer></v-spacer>
  ...
  methods: {
    ...
    filterKantor() {
      ...
      if (this.editedItem.id_kantor != "") {
        if (this.$gate.isAdmin() || this.$gate.isAK()) {
          axios
            .get("api/stockpromosi/filterkantor", {
              params: {
    ...
    filterBarang() {
      ...
      if (this.editedItem.barang_id != "") {
        if (this.$gate.isAdmin() || this.$gate.isAK()) {
          axios
            .get("api/stockpromosi/filterbarang", {
              params: {
    ...
    filterTanggal() {
      ...
      if (this.periodeTglText != "") {
        if (this.$gate.isAdmin() || this.$gate.isAK()) {
          axios
            .get("api/stockpromosi/filtertanggal", {
              params: {
    ...
    getBarang() {
      if (this.$gate.isAdmin() || this.$gate.isAK()) {
        ...
        axios
          .get("api/stockpromosi/getbarang")
          .then((response) => {
    ...
    getKantor() {
      if (this.$gate.isAdmin() || this.$gate.isAK()) {
        //axios.get("api/user").then((response) => {(this.users = response.data.data)});
        axios
          .get("api/stockpromosi/getkantor")
          .then((response) => {
    ...
    getSatuan() {
      if (this.$gate.isAdmin() || this.$gate.isAK()) {
        //axios.get("api/user").then((response) => {(this.users = response.data.data)});
        axios
          .get("api/stockpromosi/getsatuan")
          .then((response) => {
    ...
    createUser() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isAK()) {
        ...
        axios
          .post("api/stockpromosi", formData, config)
          .then((response) => {
            $("#addNew").modal("hide");

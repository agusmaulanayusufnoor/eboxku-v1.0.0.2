...
//axios.get("api/user").then((response) => {(this.users = response.data.data)});
axios.get("api/kaskecil/getkantor")
    .then((response) => {
     ...
     createUser(){
         ...
         this.$Progress.start();
           ...
           // console.log(this.file);
            axios.post('api/kaskecil',formData,config)
              .then((response)=>{
                  $('#addNew').modal('hide');
          ...
          updateUser(){
                ...
                this.form.put('api/kaskecil/'+this.form.id)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ya, Hapus!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/kaskecil/'+id).then(()=>{
                                        Swal.fire(
                                        'Dihapus!',
                                        'Data telah dihapus.',
                                        'success'

    ...
    methods: {
        async cekTgl (){
            if(this.$gate.isAdmin() || this.$gate.isAK() ){
                ...
                const response = await axios.post('api/jtpelayananpusat/cektgl',formData)
         ...
         this.$Progress.start();
            ...
            if(this.$gate.isAdmin() || this.$gate.isAK() ){
             ...
             axios.get("api/jtpelayananpusat")
                .then((response) => {
                this.jtpelayananpusat = response.data.data;
     ...
     createUser(){
         ...
         this.$Progress.start();
           ...
           // console.log(this.file);
            axios.post('api/jtpelayananpusat',formData,config)
              .then((response)=>{
                  $('#addNew').modal('hide');
          ...
          updateUser(){
                ...
                this.form.put('api/jtpelayananpusat/'+this.form.id)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ya, Hapus!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/jtpelayananpusat/'+id).then(()=>{
                                        Swal.fire(
                                        'Dihapus!',
                                        'Data telah dihapus.',
                                        'success'

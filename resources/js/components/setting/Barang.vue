  ...
  export default {
    ...
    methods: {
      ...
      open (item) {
        ...
        this.editedItem.namabarang = item.namabarang
    ...
    newModal(){
     ...
     createUser(){
         ...
         this.$Progress.start();
            ...
            axios.post('api/barang',formData,config)
              .then((response)=>{
                  $('#addNew').modal('hide');
              ...
              .catch((response)=>{
                  ...
                  Toast.fire({
                      icon: 'error',
                      title: 'Gagal tambah barang, ulangi!'
          ...
          updateUser(){
               ...
               // headers: {'X-Custom-Header': 'value'}
                ...
                this.$Progress.start();
                //alert(this.editedItem.namabarang);
                 const formData = new FormData
            formData.set('namabarang', this.editedItem.namabarang)
            formData.append("_method", "PUT");
                axios.post('api/barang/'+this.editedItem.id,formData)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ya, Hapus!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/barang/'+id).then(()=>{
                                        Swal.fire(
                                        'Dihapus!',
                                        'Data telah dihapus.',
                                        'success'

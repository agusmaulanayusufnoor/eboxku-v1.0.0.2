          ...
          <v-col cols="7">
            <v-card class="pa-2 mx-auto" v-if="$gate.isAdmin()">
              ...
              <div class="card-body table-responsive p-0">
                ...
                <!-- edit table -->
                <template v-slot:item.namaotorisator="{ item }">
                     <v-edit-dialog
                        ...
                        <template v-slot:input>
                            ...
                            <v-text-field
                            v-model="editedItem.namaotorisator"
                            :rules="[max100chars]"
                            label="Edit"
                            single-line
                            counter
        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode">Tambah Otorisator</h5>
                ...
                <!-- <form @submit.prevent="editmode ? updateUser() : createUser()"> -->
                    <div class="modal-body">
                        ...
                        <div class="form-group input-group">
                             ...
                             <v-text-field
                                v-model="editedItem.namaotorisator"
                                :rules="editedItem.otorisatorRules"
                            ...
                            ></v-text-field>
                            <!-- <has-error :form="form" field="otorisator"></has-error> -->
...
<script>
  ...
  export default {
    ...
    editedItem : {
        ...
        namaotorisatorEdit:'',
        otorisatorRules: [
        v => !!v || 'Nama otorisator belum diisi',
      ],
    },
    ...
    methods: {
      ...
      open (item) {
        ...
        this.editedItem.namaotorisator = item.namaotorisator

        //console.log(this.item.namaotorisator);
        //alert(this.item.id)
      },
      close () {
      ...
      initialize() {
         this.$Progress.start();
            ...
            if(this.$gate.isAdmin()){
             ...
             axios.get("api/otorisator")
                .then((response) => {
                this.otorisator = response.data.data;
    ...
    newModal(){
     ...
     createUser(){
         ...
         this.$Progress.start();
            ...
            axios.post('api/otorisator',formData,config)
              .then((response)=>{
                  $('#addNew').modal('hide');
                    //  console.log(this.namaotorisator);
                  Toast.fire({
                        icon: 'success',
              ...
              .catch((response)=>{
                  ...
                  Toast.fire({
                      icon: 'error',
                      title: 'Gagal tambah otorisator, ulangi!'
          ...
          updateUser(){
               ...
               // headers: {'X-Custom-Header': 'value'}
                ...
                this.$Progress.start();
                //alert(this.editedItem.namaotorisator);
                 const formData = new FormData
            formData.set('namaotorisator', this.editedItem.namaotorisator)
            formData.append("_method", "PUT");
                axios.post('api/otorisator/'+this.editedItem.id,formData)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ya, Hapus!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/otorisator/'+id).then(()=>{
                                        Swal.fire(
                                        'Dihapus!',
                                        'Data telah dihapus.',
                                        'success'

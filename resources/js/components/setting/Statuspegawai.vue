            ...
            <v-col cols="7">
              <v-card class="pa-2 mx-auto" v-if="$gate.isAdmin()">
                ...
                <div class="card-body table-responsive p-0">
                  ...
                  <!-- edit table -->
                  <template v-slot:item.statuspegawai="{ item }">
                       <v-edit-dialog
                          ...
                          <template v-slot:input>
                              ...
                              <v-text-field
                              v-model="editedItem.statuspegawai"
                              :rules="[max100chars]"
                              label="Edit"
                              single-line
                              counter
          ...
          <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
              <div class="modal-dialog" role="document">
                  ...
                  <div class="modal-header">
                      <h5 class="modal-title" v-show="!editmode">Tambah Status Pegawai</h5>
                  ...
                  <!-- <form @submit.prevent="editmode ? updateUser() : createUser()"> -->
                      <div class="modal-body">
                          ...
                          <div class="form-group input-group">
                               ...
                               <v-text-field
                                  v-model="editedItem.statuspegawai"
                                  :rules="editedItem.statuspegawaiRules"
                              ...
                              ></v-text-field>
                              <!-- <has-error :form="form" field="statuspegawai"></has-error> -->
  ...
  <script>
    ...
    export default {
      ...
      editedItem : {
          ...
          statuspegawaiEdit:'',
          statuspegawaiRules: [
          v => !!v || 'Nama statuspegawai belum diisi',
        ],
      },
      ...
      methods: {
        ...
        open (item) {
          ...
          this.editedItem.statuspegawai = item.statuspegawai
  
          //console.log(this.item.statuspegawai);
          //alert(this.item.id)
        },
        close () {
      ...
      newModal(){
       ...
       createUser(){
           ...
           this.$Progress.start();
              ...
              axios.post('api/statuspegawai',formData,config)
                .then((response)=>{
                    $('#addNew').modal('hide');
                      //  console.log(this.statuspegawai);
                    Toast.fire({
            ...
            updateUser(){
                 ...
                 // headers: {'X-Custom-Header': 'value'}
                  ...
                  this.$Progress.start();
                  //alert(this.editedItem.statuspegawai);
                   const formData = new FormData
              formData.set('statuspegawai', this.editedItem.statuspegawai)
              formData.append("_method", "PUT");
                  axios.post('api/statuspegawai/'+this.editedItem.id,formData)
                  .then((response) => {
                      // success
                      $('#addNew').modal('hide');
                      Toast.fire({
                  ...
                  Swal.fire({
                      ...
                      confirmButtonText: 'Ya, Hapus!'
                          ...
                          // Send request to the server
                           if (result.value) {
                                  this.form.delete('api/statuspegawai/'+id).then(()=>{
                                          Swal.fire(
                                          'Dihapus!',
                                          'Data telah dihapus.',
                                          'success'

          ...
          <v-col cols="7">
            <v-card class="pa-2 mx-auto" v-if="$gate.isAdmin()">
              ...
              <div class="card-body table-responsive p-0">
                ...
                <!-- edit table -->
                <template v-slot:item.statuspajak="{ item }">
                     <v-edit-dialog
                        ...
                        <template v-slot:input>
                            ...
                            <v-text-field
                            v-model="editedItem.statuspajak"
                            :rules="[max100chars]"
                            label="Edit"
                            single-line
                            counter
        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode">Tambah Status Pajak</h5>
                ...
                <!-- <form @submit.prevent="editmode ? updateUser() : createUser()"> -->
                    <div class="modal-body">
                        ...
                        <div class="form-group input-group">
                             ...
                             <v-text-field
                                v-model="editedItem.statuspajak"
                                :rules="editedItem.statuspajakRules"
                                label="Status Pajak"
                                name="statuspajak"
                                placeholder="input"
                                outlined
                            ...
                            ></v-text-field>
                            <!-- <has-error :form="form" field="statuspajak"></has-error> -->
...
<script>
  ...
  export default {
    ...
    editedItem : {
        ...
        statuspajakEdit:'',
        statuspajakRules: [
        v => !!v || 'Nama statuspajak belum diisi',
      ],
    },
    ...
    methods: {
      ...
      open (item) {
        ...
        this.editedItem.statuspajak = item.statuspajak

        //console.log(this.item.statuspajak);
        //alert(this.item.id)
      },
      close () {
      ...
      initialize() {
         this.$Progress.start();
            ...
            if(this.$gate.isAdmin()){
             ...
             axios.get("api/statuspajak")
                .then((response) => {
                this.statuspajak = response.data.data;
    ...
    newModal(){
     ...
     createUser(){
         ...
         this.$Progress.start();
            ...
            axios.post('api/statuspajak',formData,config)
              .then((response)=>{
                  $('#addNew').modal('hide');
                    //  console.log(this.statuspajak);
                  Toast.fire({
              ...
              .catch((response)=>{
                  ...
                  Toast.fire({
                      icon: 'error',
                      title: 'Gagal tambah status pajak, ulangi!'
          ...
          updateUser(){
               ...
               // headers: {'X-Custom-Header': 'value'}
                ...
                this.$Progress.start();
                //alert(this.editedItem.statuspajak);
                 const formData = new FormData
            formData.set('statuspajak', this.editedItem.statuspajak)
            formData.append("_method", "PUT");
                axios.post('api/statuspajak/'+this.editedItem.id,formData)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ya, Hapus!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/statuspajak/'+id).then(()=>{
                                        Swal.fire(
                                        'Dihapus!',
                                        'Data telah dihapus.',
                                        'success'

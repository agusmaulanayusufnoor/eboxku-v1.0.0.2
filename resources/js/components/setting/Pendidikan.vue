            ...
            <v-card class="pa-2 mx-auto" v-if="$gate.isAdmin()">
              ...
              <div class="card-body table-responsive p-0">
                ...
                <v-toolbar flat >
                    ...
                    label="Cari Pendidikan Terakhir"
                    single-line
                    hide-details
                    loading="grey"
                ></v-text-field>
                ...
                <!-- edit table -->
                <template v-slot:item.pendidikan_terakhir="{ item }">
                     <v-edit-dialog
        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode">Tambah Pendidikan</h5>
                ...
                <!-- <form @submit.prevent="editmode ? updateUser() : createUser()"> -->
                    <div class="modal-body">
                        ...
                        <div class="form-group input-group">
                             ...
                             <v-text-field
                                v-model="editedItem.pendidikan_terakhir"
                                :rules="editedItem.pendidikanRules"
...
<script>
  ...
  export default {
    ...
    editedItem : {
        ...
        pendidikanRules: [
        v => !!v || 'Nama pendidikan belum diisi',
      ],
    },
    ...
    methods: {
      ...
      open (item) {
        ...
        this.editedItem.pendidikan_terakhir = item.pendidikan_terakhir

        //console.log(this.item.pendidikan_terakhir);
        //alert(this.item.id)
      },
      close () {
    ...
    newModal(){
     ...
     createUser(){
         ...
         this.$Progress.start();
            ...
            axios.post('api/pendidikan',formData,config)
              .then((response)=>{
                  $('#addNew').modal('hide');
                    //  console.log(this.pendidikan_terakhir);
                  Toast.fire({
                        icon: 'success',
              ...
              .catch((response)=>{
                  ...
                  Toast.fire({
                      icon: 'error',
                      title: 'Gagal tambah pendidikan, ulangi!'
          ...
          updateUser(){
               ...
               // headers: {'X-Custom-Header': 'value'}
                ...
                this.$Progress.start();
                //alert(this.editedItem.pendidikan_terakhir);
                 const formData = new FormData
            formData.set('pendidikan_terakhir', this.editedItem.pendidikan_terakhir)
            formData.append("_method", "PUT");
                axios.post('api/pendidikan/'+this.editedItem.id,formData)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ya, Hapus!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/pendidikan/'+id).then(()=>{
                                        Swal.fire(
                                        'Dihapus!',
                                        'Data telah dihapus.',
                                        'success'

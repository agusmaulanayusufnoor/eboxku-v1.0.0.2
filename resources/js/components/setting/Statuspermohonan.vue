                  ...
                  <template v-slot:item.statuspermohonan="{ item }">
                       <v-edit-dialog
                          ...
                          <template v-slot:input>
                              ...
                              <v-text-field
                              v-model="editedItem.statuspermohonan"
                              :rules="[max100chars]"
                              label="Edit"
                              single-line
                              counter
          ...
          <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
              <div class="modal-dialog" role="document">
                  ...
                  <div class="modal-header">
                      <h5 class="modal-title" v-show="!editmode">Tambah Status Permohonan</h5>
                  ...
                  <!-- <form @submit.prevent="editmode ? updateUser() : createUser()"> -->
                      <div class="modal-body">
                          ...
                          <div class="form-group input-group">
                               ...
                               <v-text-field
                                  v-model="editedItem.statuspermohonan"
                                  :rules="editedItem.statuspermohonanRules"
                              ...
                              ></v-text-field>
                              <!-- <has-error :form="form" field="statuspermohonan"></has-error> -->
  ...
  <script>
    ...
    export default {
      ...
      editedItem : {
          ...
          statuspermohonanRules: [
          v => !!v || 'Nama Status Permohonan belum diisi',
        ],
      },
      ...
      methods: {
        ...
        open (item) {
          ...
          this.editedItem.statuspermohonan = item.statuspermohonan

          //console.log(this.item.statuspermohonan);
          //alert(this.item.id)
        },
        close () {
        ...
        initialize() {
           this.$Progress.start();
              ...
              if(this.$gate.isAdmin()){
               ...
               axios.get("api/statuspermohonan")
                  .then((response) => {
                  this.statuspermohonan = response.data.data;
      ...
      newModal(){
       ...
       createUser(){
           ...
           this.$Progress.start();
              ...
              axios.post('api/statuspermohonan',formData,config)
                .then((response)=>{
                    $('#addNew').modal('hide');
                      //  console.log(this.statuspermohonan);
                    Toast.fire({
                ...
                .catch((response)=>{
                    ...
                    Toast.fire({
                        icon: 'error',
                        title: 'Gagal tambah status pegawai, ulangi!'
            ...
            updateUser(){
                 ...
                 // headers: {'X-Custom-Header': 'value'}
                  ...
                  this.$Progress.start();
                  //alert(this.editedItem.statuspermohonan);
                   const formData = new FormData
              formData.set('statuspermohonan', this.editedItem.statuspermohonan)
              formData.append("_method", "PUT");
                  axios.post('api/statuspermohonan/'+this.editedItem.id,formData)
                  .then((response) => {
                      // success
                      $('#addNew').modal('hide');
                      Toast.fire({
                  ...
                  Swal.fire({
                      ...
                      confirmButtonText: 'Ya, Hapus!'
                          ...
                          // Send request to the server
                           if (result.value) {
                                  this.form.delete('api/statuspermohonan/'+id).then(()=>{
                                          Swal.fire(
                                          'Dihapus!',
                                          'Data telah dihapus.',
                                          'success'

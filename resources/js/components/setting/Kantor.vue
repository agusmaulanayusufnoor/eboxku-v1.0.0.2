        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode">Tambah kantor</h5>
      ...
      initialize() {
         this.$Progress.start();
            ...
            if(this.$gate.isAdmin()){
             ...
             axios.get("api/kantor")
                .then((response) => {
                this.kantor = response.data.data;
         ...
         this.$Progress.start();
            ...
            axios.post('api/kantor',formData,config)
              ...
              .catch((response)=>{
                  ...
                  Toast.fire({
                      icon: 'error',
                      title: 'Gagal tambah kantor, ulangi!'
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ya, Hapus!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/kantor/'+id).then(()=>{
                                        Swal.fire(
                                        'Dihapus!',
                                        'Data telah dihapus.',
                                        'success'

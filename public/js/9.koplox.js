...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      if (this.editedItem.id_kantor != '') {
        if (this.$gate.isAdmin() || this.$gate.isAK()) {
          axios.get("api/stockctk/filterkantor", {
            ...
            /* eslint-disable */
            (_console = console).log.apply(_console, _toConsumableArray(oo_oo("71bd0be7_0", error.response.data)));
          });
        }
      } else {
      ...
      if (this.editedItem.barang_id != '') {
        if (this.$gate.isAdmin() || this.$gate.isAK()) {
          axios.get("api/stockctk/filterbarang", {
            ...
            /* eslint-disable */
            (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("71bd0be7_1", error.response.data)));
          });
        }
      } else {
        //Swal.fire("Gagal Filter", "Filter Tanggal Belum Dipilih...!", "warning");
      ...
      if (this.periodeTglText != '') {
        if (this.$gate.isAdmin() || this.$gate.isAK()) {
          axios.get("api/stockctk/filtertanggal", {
            ...
            /* eslint-disable */
            (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("71bd0be7_2", error.response.data)));
          });
        }
      } else {
        //Swal.fire("Gagal Filter", "Filter Tanggal Belum Dipilih...!", "warning");
    ...
    getBarang: function getBarang() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isAK()) {
        ...
        axios.get("api/stockctk/getbarang").then(function (response) {
          ...
          /* eslint-disable */
          (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("71bd0be7_3", error.response.data)));
        });
      }
    },
    getKantor: function getKantor() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isAK()) {
        ...
        axios.get("api/stockctk/getkantor").then(function (response) {
          ...
          /* eslint-disable */
          (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("71bd0be7_4", error.response.data)));
        });
      }
    },
    getSatuan: function getSatuan() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isAK()) {
        ...
        axios.get("api/stockctk/getsatuan").then(function (response) {
          ...
          /* eslint-disable */
          (_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("71bd0be7_5", error.response.data)));
        });
      }
    },
    initialize: function initialize() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isAK()) {
        ...
        axios.get("api/stockctk").then(function (response) {
          ...
          (_console7 = console).log.apply(_console7, _toConsumableArray(oo_oo("71bd0be7_6", _this7.stock))); //console.log(this.kantor_id)

        })["catch"](function (error) {
          var _console8;

          /* eslint-disable */
          (_console8 = console).log.apply(_console8, _toConsumableArray(oo_oo("71bd0be7_7", error.response.data)));
        });
      }
    ...
    editModal: function editModal(item) {
      ...
      (_console9 = console).log.apply(_console9, _toConsumableArray(oo_oo("71bd0be7_8", this.$kantor_id)));
    },
    ...
    updateUser: function updateUser() {
      ...
      .then(function (response) {
        ...
        /* eslint-disable */
        (_console10 = console).log.apply(_console10, _toConsumableArray(oo_oo("71bd0be7_9", _this9.editedItem.id))); // success
        ...
        /* eslint-disable */
        (_console11 = console).log.apply(_console11, _toConsumableArray(oo_oo("71bd0be7_10", error)));

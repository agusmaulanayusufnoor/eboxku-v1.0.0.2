...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("a8385f85_0", this.kantor_id)));
  ...
  methods: {
    ...
    getOtorisator: function getOtorisator() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isAK()) {
        ...
        axios.get("api/kaskecil/getotorisator").then(function (response) {
          ...
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("a8385f85_1", error.response.data)));
        });
      }
    },
            ...
            switch (_context.prev = _context.next) {
              case 0:
                if (_this2.$gate.isAdmin()) {
                  //axios.get("api/user").then((response) => {(this.users = response.data.data)});
                  axios.get("api/kaskecil/getkantor").then(function (response) {
                    var _console3, _console4;

                    _this2.namaKantor = response.data.data;
                    /* eslint-disable */

                    (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("a8385f85_2", _this2.namaKantor)));
                    /* eslint-disable */


                    (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("a8385f85_3", _this2.kantor_id)));
                  })["catch"](function (error) {
                    var _console5;

                    /* eslint-disable */
                    (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("a8385f85_4", error.response.data)));
                  });
                }
                ...
                if (_this3.nama_kantor != '') {
                  if (_this3.$gate.isAdmin()) {
                    axios.get("api/kaskecil/filterkantor", {
                      ...
                      _this3.kaskecil = response.data.data;
                      ...
                      /* eslint-disable */
                      (_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("a8385f85_5", error.response.data)));
                    });
                  }
                } else {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                if (_this4.otorisator_id != '') {
                  if (_this4.$gate.isAdmin() || _this4.$gate.isAK()) {
                    axios.get("api/kaskecil/filterotorisator", {
                      ...
                      _this4.kaskecil = response.data.data;
                      ...
                      /* eslint-disable */
                      (_console7 = console).log.apply(_console7, _toConsumableArray(oo_oo("a8385f85_6", error.response.data)));
                    });
                  }
                } else {
                  //Swal.fire("Gagal Filter", "Filter Tanggal Belum Dipilih...!", "warning");
                ...
                _this4.$refs.cboto.reset();

                _this4.$refs.cbkantor.reset();
    ...
    initialize: function initialize() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isAK()) {
        ...
        axios.get("api/kaskecil").then(function (response) {
          _this5.kaskecil = response.data.data;
    ...
    deleteUser: function deleteUser(id) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this8.form["delete"]('api/kaskecil/' + id).then(function () {

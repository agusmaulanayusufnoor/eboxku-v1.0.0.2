...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    close: function close() {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2359e7ef_0", 'Dialog closed')));
    },
    ...
    editjabatan: function editjabatan(item) {
      ...
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2359e7ef_1", this.item.id))); //alert(this.item.id)

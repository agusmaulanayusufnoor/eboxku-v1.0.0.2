...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/kredit/Permohonankredit.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/kredit/Permohonankredit.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data(vm) {
    return {
      ...
      file_disetujui: null,
      file_spk: null,
      noktpRules: [function (v) {
        return !!v || "No KTP Belum Diisi";
      }],
      cekNorekData: [],
      pesaneror: [],
      ...
      tgl_permohonan: new Date(Date.now() - new Date().getTimezoneOffset() * 60000).toISOString().substr(0, 10),
      tgl_permohonanRules: [function (v) {
  ...
  watch: {
    tgl_permohonan: function tgl_permohonan(val) {
  ...
  methods: {
    getColor: function getColor(statuspermohonan) {
      if (statuspermohonan === 'Selesai') return 'green';else if (statuspermohonan === 'Ditolak') return 'red';else return 'orange';
    },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                formData.set("no_ktp", _this.editedItem.no_ktp); //const response = await axios.get('api/kredit/ceknama')

                _context.next = 5;
                return axios.post("api/permohonankredit/ceknorek", formData);
              ...
              case 5:
                ...
                if (response.data.message == "adarek") {
                  _this.cekNorekData = response.data.data[0].no_ktp;
                  _this.pesaneror = "No KTP " + _this.cekNorekData + " Sudah Ada"; // console.log(this.cekNorekData);

                  Toast.fire({
                    icon: "error",
                    //title: response.data.message
                    title: "No KTP " + response.data.data[0].no_ktp + " Sudah Ada Dalam Data"
                  });
    ...
    noktpKeyboard: function noktpKeyboard(evt) {
      evt = evt ? evt : window.event;
      var charCode = evt.which ? evt.which : evt.keyCode; //nomer wungkul
    ...
    formatDate: function formatDate(tgl_permohonan) {
      if (!tgl_permohonan) return null;

      var _tgl_permohonan$split = tgl_permohonan.split("-"),
          _tgl_permohonan$split2 = _slicedToArray(_tgl_permohonan$split, 3),
          year = _tgl_permohonan$split2[0],
          month = _tgl_permohonan$split2[1],
          day = _tgl_permohonan$split2[2];

      return "".concat(day, "/").concat(month, "/").concat(year);
    },
    parseDate: function parseDate(tgl_permohonan) {
      if (!tgl_permohonan) return null;

      var _tgl_permohonan$split3 = tgl_permohonan.split("/"),
          _tgl_permohonan$split4 = _slicedToArray(_tgl_permohonan$split3, 3),
          day = _tgl_permohonan$split4[0],
          month = _tgl_permohonan$split4[1],
          year = _tgl_permohonan$split4[2];
    ...
    initialize: function initialize() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isKredit() || this.$gate.isBisnis()) {
        axios.get("api/permohonankredit").then(function (response) {
          _this2.permohonankredit = response.data.data;
    ...
    editModal: function editModal(item) {
      ...
      $("#addNew").modal("show"); //this.form.fill(item);
    ...
    createUser: function createUser() {
      ...
      formData.set("status_id", 1); // formData.append('file', this.file);
      // console.log(this.file);

      axios.post("api/permohonankredit", formData, config).then(function (response) {
        $("#addNew").modal("hide");
        Toast.fire({
          icon: "success",
          title: response.data.message
    ...
    downloadFileDisetujui: function downloadFileDisetujui(id, file_disetujui) {
      axios({
        ...
        document.body.appendChild(fileLink); // console.log(fileLink.download)

        fileLink.click();
      })["catch"](function () {
        Swal.fire("Gagal Download!", "File disetujui belum diupload.", "warning");
      });
    },
    downloadFileSpk: function downloadFileSpk(id, file_spk) {
      axios({
    ...
    updateUser: function updateUser() {
      ...
      var formData = new FormData(); // formData.set('kantor_id', this.editedItem.kantor_id)
      ...
      axios.post("api/permohonankredit/" + this.editedItem.id, formData, config) //axios.put('api/stock/27',formData)
      .then(function (response) {
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("a32ee734_0", error)));
    ...
    deleteUser: function deleteUser(id) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this5.form["delete"]("api/permohonankredit/" + id).then(function () {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/kredit/Permohonankredit.vue?vue&type=template&id=b700c26e&":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/kredit/Permohonankredit.vue?vue&type=template&id=b700c26e& ***!
  \**************************************************************************************************************************************************************************************************************************/
                                            ...
                                            [
                                              _c(
                                                "v-icon",
                                                {
                                                  ...
                                                  on: {
                                                    click: function ($event) {
                                                      return _vm.downloadFileDisetujui(
                                                        item.id,
                                                        item.file_disetujui
                                                      )
                                                    },
                        ...
                        [
                          _c("div", { staticClass: "modal-body" }, [
                            ...
                            _c("input", {
                              ...
                              attrs: { type: "hidden", name: "status_id" },
                              domProps: { value: _vm.editedItem.status_id },
                              on: {
                                input: function ($event) {
                                  if ($event.target.composing) {
                                    return
                                ...
                                _c(
                                  ...
                                  [
                                    _c("v-text-field", {
                                      ...
                                      on: {
                                        keydown: function ($event) {
                                          return _vm.noktpKeyboard($event)
                                        },
                                    ...
                                    _c("v-text-field", {
                                      ...
                                      model: {
                                        value: _vm.editedItem.no_rekening,
                                        callback: function ($$v) {
                                          _vm.$set(
                                            _vm.editedItem,
                                            "no_rekening",
                                        ...
                                        expression: "editedItem.no_rekening",
                                      },
                                    }),
                                    _vm._v(" "),
                                    _c("has-error", {
                                              ...
                                              _c(
                                                ...
                                                [
                                                  ...
                                                  _c("v-date-picker", {
                                                    ...
                                                    model: {
                                                      value: _vm.tgl_permohonan,
                                                      callback: function ($$v) {
                                                        _vm.tgl_permohonan = $$v
                                                      },
                                                      expression:
                                                        "tgl_permohonan",
                                                    },
...
/***/ "./resources/js/components/kredit/Permohonankredit.vue":
/*!*************************************************************!*\
  !*** ./resources/js/components/kredit/Permohonankredit.vue ***!
  \*************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Permohonankredit_vue_vue_type_template_id_b700c26e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Permohonankredit.vue?vue&type=template&id=b700c26e& */ "./resources/js/components/kredit/Permohonankredit.vue?vue&type=template&id=b700c26e&");
/* harmony import */ var _Permohonankredit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Permohonankredit.vue?vue&type=script&lang=js& */ "./resources/js/components/kredit/Permohonankredit.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _Permohonankredit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _Permohonankredit_vue_vue_type_template_id_b700c26e___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Permohonankredit_vue_vue_type_template_id_b700c26e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/kredit/Permohonankredit.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/kredit/Permohonankredit.vue?vue&type=script&lang=js&":
/*!**************************************************************************************!*\
  !*** ./resources/js/components/kredit/Permohonankredit.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Permohonankredit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./Permohonankredit.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/kredit/Permohonankredit.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Permohonankredit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/kredit/Permohonankredit.vue?vue&type=template&id=b700c26e&":
/*!********************************************************************************************!*\
  !*** ./resources/js/components/kredit/Permohonankredit.vue?vue&type=template&id=b700c26e& ***!
  \********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Permohonankredit_vue_vue_type_template_id_b700c26e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Permohonankredit.vue?vue&type=template&id=b700c26e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/kredit/Permohonankredit.vue?vue&type=template&id=b700c26e&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Permohonankredit_vue_vue_type_template_id_b700c26e___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Permohonankredit_vue_vue_type_template_id_b700c26e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });

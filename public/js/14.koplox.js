...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("549114de_0", this.kantor_id)));
            ...
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                if (response.data.message == 'adatgl') {
                  ...
                  (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("549114de_1", _this.cekTglData)));

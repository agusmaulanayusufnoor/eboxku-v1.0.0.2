...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                formData.set("no_rekening", _this.editedItem.no_rekening); //const response = await axios.get('api/kredit/ceknama')
    ...
    updateUser: function updateUser() {
      ...
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("44149c66_0", formData)));
      ...
      .then(function (response) {
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("44149c66_1", _this4.editedItem.id))); // success
        ...
        /* eslint-disable */
        (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("44149c66_2", error)));

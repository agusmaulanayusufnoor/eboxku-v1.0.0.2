              ...
              case 0:
                if (_this2.$gate.isAdmin()) {
                  ...
                  axios.get("api/rekkoranaba/getkantor").then(function (response) {
                    ...
                    /* eslint-disable */
                    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("10d62220_0", error.response.data)));
                  });
                }
                ...
                if (_this3.nama_kantor != '') {
                  if (_this3.$gate.isAdmin()) {
                    axios.get("api/rekkoranaba/filterkantor", {
                      ...
                      /* eslint-disable */
                      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("10d62220_1", error.response.data)));
                    });
                  }
                } else {
                ...
                if (_this4.jenis != '') {
                  if (_this4.$gate.isAdmin() || _this4.$gate.isAK()) {
                    axios.get("api/rekkoranaba/filterjenis", {
                      ...
                      /* eslint-disable */
                      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("10d62220_2", error.response.data)));
                    });
                  }
                } else {
                  //Swal.fire("Gagal Filter", "Filter Tanggal Belum Dipilih...!", "warning");

...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("d00b8e3f_0", this.kantor_id)));
  ...
  methods: {
    getKantor: function getKantor() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isKredit()) {
        ...
        axios.get("api/pjkpph21/getkantor").then(function (response) {
          ...
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("d00b8e3f_1", error.response.data)));
        });
      }
    },
    ...
    createUser: function createUser() {
      ...
      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("d00b8e3f_2", this.tanggal)));

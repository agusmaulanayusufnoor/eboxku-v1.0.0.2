  ...
  methods: {
    ...
    getOtorisator: function getOtorisator() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isPelayanan()) {
        ...
        axios.get("api/teller/getotorisator").then(function (response) {
          ...
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3baff6ed_0", error.response.data)));
        });
      }
    },
              ...
              case 0:
                if (_this2.$gate.isAdmin()) {
                  ...
                  axios.get("api/teller/getkantor").then(function (response) {
                    ...
                    (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3baff6ed_1", _this2.namaKantor)));
                    /* eslint-disable */


                    (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("3baff6ed_2", _this2.kantor_id)));
                  })["catch"](function (error) {
                    var _console4;

                    /* eslint-disable */
                    (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("3baff6ed_3", error.response.data)));
                  });
                }
                ...
                if (_this3.nama_kantor != '') {
                  if (_this3.$gate.isAdmin()) {
                    axios.get("api/teller/filterkantor", {
                      ...
                      (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("3baff6ed_4", _this3.nama_kantor)));
                    })["catch"](function (error) {
                      var _console6;

                      /* eslint-disable */
                      (_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("3baff6ed_5", error.response.data)));
                    });
                  }
                } else {
                ...
                if (_this4.otorisator_id != '') {
                  if (_this4.$gate.isAdmin() || _this4.$gate.isPelayanan()) {
                    axios.get("api/teller/filterotorisator", {
                      ...
                      /* eslint-disable */
                      (_console7 = console).log.apply(_console7, _toConsumableArray(oo_oo("3baff6ed_6", error.response.data)));
                    });
                  }
                } else {
                  //Swal.fire("Gagal Filter", "Filter Tanggal Belum Dipilih...!", "warning");
    ...
    initialize: function initialize() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isPelayanan()) {
        //axios.get("api/user").then((response) => {(this.users = response.data.data)});
        axios.get("api/teller").then(function (response) {
          _this6.teller = response.data.data;
    ...
    deleteUser: function deleteUser(id) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this9.form["delete"]('api/teller/' + id).then(function () {

...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      if (this.fromTglText != '' && this.toTglText != '') {
        if (this.$gate.isAdmin() || this.$gate.isAK()) {
          axios.get("api/stock/filtertanggal", {
            ...
            /* eslint-disable */
            (_console = console).log.apply(_console, _toConsumableArray(oo_oo("57fad8fb_0", error.response.data)));
          });
        }
      } else {
    ...
    initialize: function initialize() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isAK()) {
        ...
        axios.get("api/stock").then(function (response) {
          ...
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("57fad8fb_1", error.response.data)));
        });
      }
    ...
    editModal: function editModal(item) {
      ...
      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("57fad8fb_2", this.$kantor_id)));
    },
    ...
    updateUser: function updateUser() {
      ...
      .then(function (response) {
        ...
        /* eslint-disable */
        (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("57fad8fb_3", _this4.editedItem.id))); // success
        ...
        /* eslint-disable */
        (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("57fad8fb_4", error)));

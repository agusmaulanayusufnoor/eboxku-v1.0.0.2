    ...
    getKantor: function getKantor() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isKredit() || $gate.isBisnis()) {
        ...
        axios.get("api/pelunasan/getkantor").then(function (response) {
          ...
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("19a22764_0", error.response.data)));
        });
      }
    },
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(_this2.$gate.isAdmin() || _this2.$gate.isKredit() || _this2.$gate.isBisnis())) {
                  _context.next = 7;
                  break;
                }

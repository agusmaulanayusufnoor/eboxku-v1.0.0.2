...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("6cebc173_0", this.kantor_id)));
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (_this2.$gate.isAdmin() || _this2.$gate.isBisnis()) {
                  //axios.get("api/user").then((response) => {(this.users = response.data.data)});
                  axios.get("api/asuransikredit/getkantor").then(function (response) {
                    ...
                    /* eslint-disable */
                    (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("6cebc173_1", error.response.data)));
                  });
                }
                ...
                if (_this3.nama_kantor != '') {
                  if (_this3.$gate.isAdmin()) {
                    axios.get("api/asuransikredit/filterkantor", {
                      ...
                      /* eslint-disable */
                      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("6cebc173_2", error.response.data)));
                    });
                  }
                } else {

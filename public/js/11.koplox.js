...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("b43224ee_0", this.kantor_id)));
              ...
              case 0:
                if (_this2.$gate.isAdmin()) {
                  ...
                  axios.get("api/asuransikredit/getkantor").then(function (response) {
                    ...
                    /* eslint-disable */
                    (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("b43224ee_1", error.response.data)));
                  });
                }
                ...
                if (_this3.nama_kantor != '') {
                  if (_this3.$gate.isAdmin()) {
                    axios.get("api/asuransikredit/filterkantor", {
                      ...
                      /* eslint-disable */
                      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("b43224ee_2", error.response.data)));
                    });
                  }
                } else {

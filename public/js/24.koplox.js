...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    close: function close() {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1c8dfeb1_0", 'Dialog closed')));
    },
    ...
    editBarang: function editBarang(item) {
      ...
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1c8dfeb1_1", this.item.id))); //alert(this.item.id)

...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/setting/Statuspermohonan.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/setting/Statuspermohonan.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      editedItem: {
        id: '',
        statuspermohonan: '',
        statuspermohonanEdit: '',
        statuspermohonanRules: [function (v) {
          return !!v || 'Nama Status Permohonan belum diisi';
        }]
      },
      valid: true,
      kantor_id: '',
  ...
  methods: {
    ...
    open: function open(item) {
      ...
      this.editedItem.statuspermohonan = item.statuspermohonan; //console.log(this.item.statuspermohonan);
      //alert(this.item.id)
    },
    close: function close() {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3412c9c9_0", 'Dialog closed')));
    },
    ...
    initialize: function initialize() {
      ...
      if (this.$gate.isAdmin()) {
        ...
        axios.get("api/statuspermohonan").then(function (response) {
          _this.statuspermohonan = response.data.data; // this.kantor_id = this.$kantor_id;
          // this.form.fill
          //console.log(this.statuspermohonan);
    ...
    editstatuspermohonan: function editstatuspermohonan(item) {
      var _console2;

      this.editedIndex = this.statuspermohonan.indexOf(item);
      this.item.id = item.id;
      this.item.statuspermohonan = item.statuspermohonan;
      /* eslint-disable */

      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3412c9c9_1", this.item.id))); //alert(this.item.id)
    ...
    newModal: function newModal() {
      ...
      this.editedItem.statuspermohonan = '';
    },
    createUser: function createUser() {
      ...
      formData.set('statuspermohonan', this.editedItem.statuspermohonan);
      axios.post('api/statuspermohonan', formData, config).then(function (response) {
        $('#addNew').modal('hide'); //  console.log(this.statuspermohonan);
    ...
    updateUser: function updateUser() {
      ...
      this.$Progress.start(); //alert(this.editedItem.statuspermohonan);

      var formData = new FormData();
      formData.set('statuspermohonan', this.editedItem.statuspermohonan);
      formData.append("_method", "PUT");
      axios.post('api/statuspermohonan/' + this.editedItem.id, formData).then(function (response) {
        // success
        $('#addNew').modal('hide');
        Toast.fire({
          icon: 'success',
    ...
    deleteUser: function deleteUser(id) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this4.form["delete"]('api/statuspermohonan/' + id).then(function () {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/setting/Statuspermohonan.vue?vue&type=template&id=ea9deb5e&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/setting/Statuspermohonan.vue?vue&type=template&id=ea9deb5e& ***!
  \***************************************************************************************************************************************************************************************************************************/
                    ...
                    [
                      _c("div", { staticClass: "modal-header" }, [
                        _c(
                          ...
                          [_vm._v("Tambah Status Permohonan")]
                        ),
                        _vm._v(" "),
                        _c(
                          "h5",
                                ...
                                _c(
                                  ...
                                  [
                                    _c("v-text-field", {
                                      attrs: {
                                        rules:
                                          _vm.editedItem.statuspermohonanRules,
                                      ...
                                      model: {
                                        value: _vm.editedItem.statuspermohonan,
                                        callback: function ($$v) {
                                          _vm.$set(
                                            _vm.editedItem,
                                            "statuspermohonan",
...
/***/ "./resources/js/components/setting/Statuspermohonan.vue":
/*!**************************************************************!*\
  !*** ./resources/js/components/setting/Statuspermohonan.vue ***!
  \**************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Statuspermohonan_vue_vue_type_template_id_ea9deb5e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Statuspermohonan.vue?vue&type=template&id=ea9deb5e& */ "./resources/js/components/setting/Statuspermohonan.vue?vue&type=template&id=ea9deb5e&");
/* harmony import */ var _Statuspermohonan_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Statuspermohonan.vue?vue&type=script&lang=js& */ "./resources/js/components/setting/Statuspermohonan.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _Statuspermohonan_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _Statuspermohonan_vue_vue_type_template_id_ea9deb5e___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Statuspermohonan_vue_vue_type_template_id_ea9deb5e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/setting/Statuspermohonan.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/setting/Statuspermohonan.vue?vue&type=script&lang=js&":
/*!***************************************************************************************!*\
  !*** ./resources/js/components/setting/Statuspermohonan.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Statuspermohonan_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./Statuspermohonan.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/setting/Statuspermohonan.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Statuspermohonan_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/setting/Statuspermohonan.vue?vue&type=template&id=ea9deb5e&":
/*!*********************************************************************************************!*\
  !*** ./resources/js/components/setting/Statuspermohonan.vue?vue&type=template&id=ea9deb5e& ***!
  \*********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Statuspermohonan_vue_vue_type_template_id_ea9deb5e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Statuspermohonan.vue?vue&type=template&id=ea9deb5e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/setting/Statuspermohonan.vue?vue&type=template&id=ea9deb5e&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Statuspermohonan_vue_vue_type_template_id_ea9deb5e___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Statuspermohonan_vue_vue_type_template_id_ea9deb5e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });

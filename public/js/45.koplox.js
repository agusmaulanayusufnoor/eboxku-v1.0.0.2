...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    close: function close() {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("c119486b_0", 'Dialog closed')));
    },
    ...
    getKantor: function getKantor() {
      ...
      if (this.$gate.isAdmin() || this.$gate.isUM()) {
        ...
        axios.get("api/pjkkendaraan/getkantor").then(function (response) {
          ...
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("c119486b_1", error.response.data)));
        });
      }
    },
                ...
                if (_this3.nama_kantor != '') {
                  if (_this3.$gate.isAdmin()) {
                    axios.get("api/pjkkendaraan/filterkantor", {
                      ...
                      /* eslint-disable */
                      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("c119486b_2", error.response.data)));
                    });
                  }
                } else {
                ...
                if (_this4.statusFilter != '') {
                  if (_this4.$gate.isAdmin() || _this4.$gate.isUM() || _this4.$gate.isSekdir()) {
                    axios.get("api/pjkkendaraan/filterstatus", {
                      ...
                      /* eslint-disable */
                      (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("c119486b_3", error.response.data)));
                    });
                  }
                } else {
                  //Swal.fire("Gagal Filter", "Filter Tanggal Belum Dipilih...!", "warning");
